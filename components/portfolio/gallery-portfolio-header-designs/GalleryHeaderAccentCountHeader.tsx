...
const DEFAULT_BADGE_TEXT = '{count}+ moments';
const DEFAULT_LEAD_TEXT = 'A curated set of images and moments worth revisiting.';

const SIZE_CLASS: Record<PortfolioGalleryHeaderTitleSize, string> = {
...
const LEAD_WEIGHT_CLASS: Record<PortfolioGalleryHeaderTitleWeight, string> = {
  light: 'font-normal',
  regular: 'font-medium',
 ...
 * recedes on scroll.
 */
export function GalleryHeaderAccentCountHeader({
  ...
  const badgeColor = galleryHeaderPaletteTokenColor(presentation.headerAccentCountBadgeColor ?? 'principal');
  const leadColor = galleryHeaderPaletteTokenColor(presentation.headerAccentCountLeadColor ?? 'secondaire');
  ...
  useEffect(() => {
    ...
    const triggerAnimation = () => {
      ...
      const badge = section.querySelector<HTMLElement>('[data-gallery-header-badge]');
      const leadEl = section.querySelector<HTMLElement>('[data-gallery-header-lead]');
  ...
  return (
    <div
      ...
      data-gallery-header="accent-count"
    >
      <p
