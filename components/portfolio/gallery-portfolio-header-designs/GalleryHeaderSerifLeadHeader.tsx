...
const DEFAULT_TITLE_TEXT = 'A curated collection of images, films, and chosen moments.';
 ...
 */
export function GalleryHeaderSerifLeadHeader({
  subtitle,
  ...
  const labelTone = galleryHeaderPaletteTokenColor(presentation.headerSerifLeadLabelColor ?? 'texteFort');
  const titleTone = galleryHeaderPaletteTokenColor(presentation.headerSerifLeadTitleColor ?? 'texteFort');
  const subtitleTone = galleryHeaderPaletteTokenColor(presentation.headerSerifLeadSubtitleColor ?? 'texteFort');
  ...
  useLayoutEffect(() => {
    ...
    const scroller = galleryHeaderScrollParent(header);
