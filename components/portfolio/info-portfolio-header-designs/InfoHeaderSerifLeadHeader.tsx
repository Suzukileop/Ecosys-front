...
const DEFAULT_TITLE_TEXT = 'A closer look at who I am and how I work.';
 ...
 */
export function InfoHeaderSerifLeadHeader({
  subtitle,
  ...
  const labelTone = infoHeaderPaletteTokenColor(presentation.headerSerifLeadLabelColor ?? 'texteFort');
  const titleTone = infoHeaderPaletteTokenColor(presentation.headerSerifLeadTitleColor ?? 'texteFort');
  const subtitleTone = infoHeaderPaletteTokenColor(presentation.headerSerifLeadSubtitleColor ?? 'texteFort');
  ...
  useLayoutEffect(() => {
    ...
    const scroller = infoHeaderScrollParent(header);
