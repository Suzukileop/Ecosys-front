...
const LABEL_SIZE_CLASS: Record<PortfolioContactHeaderTitleSize, string> = {
  sm: 'text-[0.6rem]',
  md: 'text-[0.7rem]',
  lg: 'text-[0.82rem]',
  xl: 'text-[0.95rem]',
...
const TITLE_WEIGHT: Record<PortfolioContactHeaderTitleWeight, { italic: number; regular: number }> = {
...
const LABEL_WEIGHT_CLASS: Record<PortfolioContactHeaderTitleWeight, string> = {
  light: 'font-normal',
  regular: 'font-medium',
 ...
 */
export function ContactHeaderSplitHeadingHeader({
  ...
  const muted = contactHeaderPaletteTokenColor(presentation.headerSplitHeadingLabelColor ?? 'secondaire');
  ...
  return (
    <div
      ...
      data-contact-header="split-heading"
    >
