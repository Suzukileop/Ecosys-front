...
const DEFAULT_TITLE_TEXT = 'A curated set of apps, platforms, and daily tools.';
 ...
 */
export function ToolsHeaderSerifLeadHeader({
  subtitle,
  ...
  const labelTone = toolsHeaderPaletteTokenColor(presentation.headerSerifLeadLabelColor ?? 'texteFort');
  const titleTone = toolsHeaderPaletteTokenColor(presentation.headerSerifLeadTitleColor ?? 'texteFort');
  const subtitleTone = toolsHeaderPaletteTokenColor(presentation.headerSerifLeadSubtitleColor ?? 'texteFort');
  ...
  useLayoutEffect(() => {
    ...
    const scroller = toolsHeaderScrollParent(header);
