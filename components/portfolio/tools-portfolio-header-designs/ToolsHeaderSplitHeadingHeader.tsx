...
const LABEL_SIZE_CLASS: Record<PortfolioToolsHeaderTitleSize, string> = {
  sm: 'text-[0.6rem]',
  md: 'text-[0.7rem]',
  lg: 'text-[0.82rem]',
  xl: 'text-[0.95rem]',
...
const TITLE_WEIGHT: Record<PortfolioToolsHeaderTitleWeight, { italic: number; regular: number }> = {
...
const LABEL_WEIGHT_CLASS: Record<PortfolioToolsHeaderTitleWeight, string> = {
  light: 'font-normal',
  regular: 'font-medium',
 ...
 */
export function ToolsHeaderSplitHeadingHeader({
  ...
  const muted = toolsHeaderPaletteTokenColor(presentation.headerSplitHeadingLabelColor ?? 'secondaire');
  ...
  return (
    <div
      ...
      data-tools-header="split-heading"
    >
