...
const SIZE_CLASS: Record<PortfolioTeamHeaderTitleSize, string> = {
...
const LEAD_WEIGHT_CLASS: Record<PortfolioTeamHeaderTitleWeight, string> = {
  light: 'font-normal',
  regular: 'font-medium',
 ...
 * recedes on scroll.
 */
export function TeamHeaderAccentCountHeader({
  ...
  const badgeColor = teamHeaderPaletteTokenColor(presentation.headerAccentCountBadgeColor ?? 'principal');
  const leadColor = teamHeaderPaletteTokenColor(presentation.headerAccentCountLeadColor ?? 'secondaire');
  ...
  useEffect(() => {
    ...
    const triggerAnimation = () => {
      ...
      const badge = section.querySelector<HTMLElement>('[data-team-header-badge]');
      const leadEl = section.querySelector<HTMLElement>('[data-team-header-lead]');
