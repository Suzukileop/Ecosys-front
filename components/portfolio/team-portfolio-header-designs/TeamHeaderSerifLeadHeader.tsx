...
const DEFAULT_TITLE_TEXT = 'A small group of people who make everything happen.';
 ...
 */
export function TeamHeaderSerifLeadHeader({
  subtitle,
  ...
  const subtitleTone = teamHeaderPaletteTokenColor(presentation.headerSerifLeadSubtitleColor ?? 'texteFort');
  ...
  useLayoutEffect(() => {
    ...
    const scroller = teamHeaderScrollParent(header);
