...
const TITLE_SIZE_CLASS: Record<PortfolioTeamHeaderTitleSize, string> = {
...
const LABEL_SIZE_CLASS: Record<PortfolioTeamHeaderTitleSize, string> = {
  sm: 'text-[0.6rem]',
  md: 'text-[0.7rem]',
  lg: 'text-[0.82rem]',
  xl: 'text-[0.95rem]',
...
const TITLE_WEIGHT: Record<PortfolioTeamHeaderTitleWeight, { italic: number; regular: number }> = {
...
const LABEL_WEIGHT_CLASS: Record<PortfolioTeamHeaderTitleWeight, string> = {
  light: 'font-normal',
  regular: 'font-medium',
 ...
 */
export function TeamHeaderSplitHeadingHeader({
  ...
  const muted = teamHeaderPaletteTokenColor(presentation.headerSplitHeadingLabelColor ?? 'secondaire');
  ...
  return (
    <div
      ...
      data-team-header="split-heading"
    >
