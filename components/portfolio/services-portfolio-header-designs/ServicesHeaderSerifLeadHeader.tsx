...
const DEFAULT_TITLE_TEXT = 'A focused set of services, built around what you need.';
 ...
 */
export function ServicesHeaderSerifLeadHeader({
  subtitle,
  ...
  const labelTone = servicesHeaderPaletteTokenColor(presentation.headerSerifLeadLabelColor ?? 'texteFort');
  const titleTone = servicesHeaderPaletteTokenColor(presentation.headerSerifLeadTitleColor ?? 'texteFort');
  const subtitleTone = servicesHeaderPaletteTokenColor(presentation.headerSerifLeadSubtitleColor ?? 'texteFort');
  ...
  useLayoutEffect(() => {
    ...
    const scroller = servicesHeaderScrollParent(header);
