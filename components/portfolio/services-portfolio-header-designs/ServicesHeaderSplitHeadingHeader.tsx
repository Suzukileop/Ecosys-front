...
const DEFAULT_LABEL_TEXT = 'Services';
const DEFAULT_TITLE_TEXT = 'Services I offer';
...
const LABEL_SIZE_CLASS: Record<PortfolioServicesHeaderTitleSize, string> = {
  sm: 'text-[0.6rem]',
  md: 'text-[0.7rem]',
  lg: 'text-[0.82rem]',
  xl: 'text-[0.95rem]',
...
const TITLE_WEIGHT: Record<PortfolioServicesHeaderTitleWeight, { italic: number; regular: number }> = {
...
const LABEL_WEIGHT_CLASS: Record<PortfolioServicesHeaderTitleWeight, string> = {
  light: 'font-normal',
  regular: 'font-medium',
 ...
 */
export function ServicesHeaderSplitHeadingHeader({
  ...
  const ink = servicesHeaderPaletteTokenColor(presentation.headerSplitHeadingTitleColor ?? 'principal');
  const muted = servicesHeaderPaletteTokenColor(presentation.headerSplitHeadingLabelColor ?? 'secondaire');
  ...
  return (
    <div
      ...
      data-services-header="split-heading"
    >
