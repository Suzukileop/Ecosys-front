...
const LABEL_SIZE_CLASS: Record<PortfolioFaqHeaderTitleSize, string> = {
  sm: 'text-[0.6rem]',
  md: 'text-[0.7rem]',
  lg: 'text-[0.82rem]',
  xl: 'text-[0.95rem]',
...
const TITLE_WEIGHT: Record<PortfolioFaqHeaderTitleWeight, { italic: number; regular: number }> = {
...
const LABEL_WEIGHT_CLASS: Record<PortfolioFaqHeaderTitleWeight, string> = {
  light: 'font-normal',
  regular: 'font-medium',
 ...
 */
export function FaqHeaderSplitHeadingHeader({
  ...
  const ink = faqHeaderPaletteTokenColor(presentation.headerSplitHeadingTitleColor ?? 'principal');
  const muted = faqHeaderPaletteTokenColor(presentation.headerSplitHeadingLabelColor ?? 'secondaire');
