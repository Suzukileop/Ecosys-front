...
const DEFAULT_TITLE_TEXT = 'Everything you need to know, clear and upfront.';
 ...
 */
export function FaqHeaderSerifLeadHeader({
  subtitle,
  ...
  const labelTone = faqHeaderPaletteTokenColor(presentation.headerSerifLeadLabelColor ?? 'texteFort');
  const titleTone = faqHeaderPaletteTokenColor(presentation.headerSerifLeadTitleColor ?? 'texteFort');
  const subtitleTone = faqHeaderPaletteTokenColor(presentation.headerSerifLeadSubtitleColor ?? 'texteFort');
  ...
  useLayoutEffect(() => {
    ...
    const scroller = faqHeaderScrollParent(header);
