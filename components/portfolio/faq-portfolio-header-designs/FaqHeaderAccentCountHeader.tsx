...
const SIZE_CLASS: Record<PortfolioFaqHeaderTitleSize, string> = {
...
const LEAD_WEIGHT_CLASS: Record<PortfolioFaqHeaderTitleWeight, string> = {
  light: 'font-normal',
  regular: 'font-medium',
 ...
 * recedes on scroll.
 */
export function FaqHeaderAccentCountHeader({
  ...
  const badgeColor = faqHeaderPaletteTokenColor(presentation.headerAccentCountBadgeColor ?? 'principal');
  const leadColor = faqHeaderPaletteTokenColor(presentation.headerAccentCountLeadColor ?? 'secondaire');
  ...
  useEffect(() => {
    ...
    const triggerAnimation = () => {
      ...
      const badge = section.querySelector<HTMLElement>('[data-faq-header-badge]');
      const leadEl = section.querySelector<HTMLElement>('[data-faq-header-lead]');
