...
export const PORTFOLIO_SETTINGS_SEARCH_INDEX: PortfolioSettingsSearchEntry[] = [
  ...
  entry('infos', 'Design & contenu', ['profile', 'side panel', 'sidebar', 'spacing', 'gap', 'espacement', 'bande infos', 'icône', 'alignement', 'infos', 'visibility'], 'sidePanel'),
  entry('infos', 'Style', ['typography', 'colors', 'profile rows', 'infos'], 'styleSide'),
  ...
  entry('whyChooseMe', 'Style', ['typography', 'colors', 'bullets', 'why me'], 'styleWhyMe'),
