...
export const PORTFOLIO_SETTINGS_SEARCH_INDEX: PortfolioSettingsSearchEntry[] = [
  ...
  entry('about', 'Panneau profil', ['profile', 'side panel', 'sidebar', 'spacing', 'gap', 'espacement', 'bande infos', 'icône', 'alignement'], 'sidePanel'),
  entry('about', 'Why me', ['why work with me', 'pourquoi', 'numérotation', 'romain', 'puces', 'bullets', 'alignement', 'colonnes', 'par ligne', 'grille', 'row', 'en ligne', 'empilé', 'inline', 'bento', 'timeline', 'split', 'elevate', '3d', 'cartes'], 'whyMe'),
