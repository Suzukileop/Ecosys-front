      ...
      <div className="flex max-w-sm flex-col items-center">
        ...
        {onNewMessage ? (
          <button
            ...
            className="mt-5 inline-flex min-h-11 items-center justify-center rounded-[10px] border border-[var(--msg-border)] bg-[var(--msg-card)] px-4 text-sm font-medium text-[var(--msg-text)] transition hover:bg-[var(--msg-bg)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--msg-brand)]/40"
          >
            New message
          </button>
        ) : null}
